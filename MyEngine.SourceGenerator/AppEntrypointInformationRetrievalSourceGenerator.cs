    ...
    public class AppEntrypointInformationRetrievalSourceGenerator : IIncrementalGenerator
    {
        public void Initialize(IncrementalGeneratorInitializationContext context)
        {
            ...
            context.RegisterSourceOutput(compilationValue, (sourceProductionContext, compilation) =>
            {
                ...
                sourceProductionContext.AddSource("EcsEngine.g.cs", $@" // <auto-generated />
#nullable enable
...
{{
    ...
    {endIfBlock}
        ...
        {
            var template = SourceTemplate.Load("EcsEngineStartupSystemInstantiation.template");
            ...
            template.SubstitutePart("ResourceChecks", string.Join(" && ", resourceChecks.Select(x => x.ResourceCheck)));
